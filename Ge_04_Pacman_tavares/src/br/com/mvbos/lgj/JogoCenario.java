...
public class JogoCenario extends CenarioPadrao {
	...
	private int espLinha = 6; // Espessura grossura linha
	...
	private void corrigePosicao(Pizza el) {
		int novaPx = el.getPx(); // Nova posicao x
		int novaPy = el.getPy(); // Nova posicao y
	...
	public void desenhar(Graphics2D g) {
		...
		// Logomarca centralizada no meio do labirinto
